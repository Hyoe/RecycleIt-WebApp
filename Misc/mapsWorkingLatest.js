function initMap() {
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function(){
      ...
      if (place.geometry.viewport){ //for places within the default view port (continents, countries)
        ...
        map.setZoom(13); //set a custom zoom level of 17
      }
        ...
        if(response_data.results){
          ...
          for(var x = 0; x < result_count; x++){
            ...
            service.getDetails(request, function(details, status) {
              ...
              infowindow.setContent('<div class="no-scroll"><strong>' + details.name + '</strong><br>' + details.formatted_address + '<br>' + details.formatted_phone_number + '<br>' + details.website);
              infowindow.open(map, marker);

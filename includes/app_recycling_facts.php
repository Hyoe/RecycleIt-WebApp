  ...
  <div class="row">
    <div class="col-md-12">
      <div class=title>
        ...
        <h3></i>Aluminum Recycling Facts</h3>
      <ul>
        ...
        <li>A 60-watt light bulb can be run for over a day on the amount of energy saved by recycling 1 pound of steel. In one year in the United States, the recycling of steel saves enough energy to heat and light 18,000,000 homes!</li>
      </ul>
      ...
      <ul>
        ...
        <li>Americans throw away 25,000,000,000 Styrofoam coffee cups every year.</li>  
      </ul>
      <h3>Glass Recycling Facts</h3>
      <ul>
      ...
      <h3>Solid Waste and Landfills</h3>
      <ul>
        <li>About one-third of an average dump is made up of packaging material!</li>
        <li> Every year, each American throws out about 1,200 pounds of organic garbage that can be composted.</li>
        <li>The U.S. is the #1 trash-producing country in the world at 1,609 pounds per person per year. This means that 5% of the world's people generate 40% of the world's waste.</li>
        <li>The highest point in Hamilton County, Ohio (near Cincinnati) is "Mount Rumpke." It is actually a mountain of trash at the Rumpke sanitary landfill towering 1045 ft. above sea level.</li>
        <li>The US population discards each year 16,000,000,000 diapers, 1,600,000,000 pens, 2,000,000,000 razor blades, 220,000,000 car tires, and enough aluminum to rebuild the US commercial air fleet four times over.</li>
        <li> Out of every $10 spent buying things, $1 (10%) goes for packaging that is thrown away. Packaging represents about 65% of household trash.</li>
        <li> On average, it costs $30 per ton to recycle trash, $50 to send it to the landfill, and $65 to $75 to incinerate it.</li>  
      </ul>
       <h3>Miscellaneous Recycling Facts</h3>
      <ul>
        <li>An estimated 80,000,000 Hershey's Kisses are wrapped each day, using enough aluminum foil to cover over 50 acres of space -- that's almost 40 football fields. All that foil is recyclable, but not many people realize it.</li>
        <li> Rainforests are being cut down at the rate of 100 acres per minute!</li>
        <li> A single quart of motor oil, if disposed of improperly, can contaminate up to 2,000,000 gallons of fresh water.</li>
        <li> Motor oil never wears out, it just gets dirty. Oil can be recycled, re-refined and used again, reducing our reliance on imported oil.</li>
        <li> On average, each one of us produces 4.4 pounds of solid waste each day. This adds up to almost a ton of trash per person, per year.</li>

...
<div class="container learn">
  ...
  <div class="row">
    ...
    <div class="col-md-4 paragraph">
      ...
      <ul>
        <li>Motor oil, oil filters, brake fluid</li>
        <li>Used antifreeze</li>
        <li>Paint, paint thinner, turpentine</li>
        <li>Cleaners with acid or lye</li>
        <li>Household batteries or car batteries</li>
        <li>Pool chemicals</li>
        <li>Fluorescent light bulbs</li>
        <li>Used needles or sharps</li>
        <li>Unwanted or expired prescriptions</li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-md-4 paragraph">
      ...
      <h4>Aluminum Cans</h4>
      <ul>
        <li> You all know these, the Coke, Pepsi, and Sprites of the world.</li>
      </ul>
      <h4>Steel and Tin Cans</h4>
      <ul>
        <li>Soup cans</li>
        <li>Veggie cans</li>
        <li>Coffee cans</li>
    ...
    <div class="col-md-4 paragraph">
      ...
      <ul>
        ...
        <li>Cereal boxes</li>
        <li>Non-Styrofoam egg cartons</li>
        <li>Some pre-packaged food boxes</li>
        <li>Newspaper</li>
        <li>Magazines and slick inserts, e.g. ads that arrive in the mail</li>
      </ul>
      * Some paper items like paper milk cartons and drink boxes are lined with wax or plastic and are often not accepted.
      ...
      <ul>
        <li>Shipping and packaging boxes</li>
      </ul>
